...
open class GradleDokkaSourceSetBuilder constructor(
    ...
    override fun build(): DokkaSourceSetImpl {
        ...
        val externalDocumentationLinks = externalDocumentationLinks.map { it.build() }
            .run {
                if (noJdkLink) this
                else this + ExternalDocumentationLink("https://docs.oracle.com/javase/${jdkVersion}/docs/api/")
            }
            .run {
            ...
            .run {
                ...
                else this + ExternalDocumentationLink("https://developer.android.com/reference/")
            }
